...
public class FarmlandRender extends MobRenderer<Farmland, BGRenderState, BGBaseGirlModel> {
    ...
    @Override
    public void extractRenderState(Farmland entity, BGRenderState state, float partialTicks) {
